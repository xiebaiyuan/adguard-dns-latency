...
describe('filterAndSortDomains', () => {
  const domains: DomainStats[] = [
    { domain: 'google.com', totalCount: 500, cachedCount: 450, cacheHitRate: 0.9, queryTypes: { A: 400, AAAA: 100 }, uncached: { p50: 15, p95: 120, slowRate: 0.02, count: 50, min: 5, max: 200, avg: 20, p20: 10, p60: 0, p70: 0, p80: 50, p99: 180, severeRate: 0 }, all: { count: 500, min: 3, max: 200, avg: 18, p20: 8, p60: 0, p70: 0, p50: 12, p80: 40, p95: 100, p99: 160, slowRate: 0.01, severeRate: 0 } },
    ...
    { domain: 'baidu.com', totalCount: 100, cachedCount: 20, cacheHitRate: 0.2, queryTypes: { A: 100 }, uncached: { p50: 200, p95: 1500, slowRate: 0.6, count: 80, min: 100, max: 3000, avg: 400, p20: 150, p60: 0, p70: 0, p80: 800, p99: 2500, severeRate: 0.3 }, all: { count: 100, min: 80, max: 3000, avg: 350, p20: 120, p60: 0, p70: 0, p50: 180, p80: 700, p95: 1200, p99: 2000, slowRate: 0.5, severeRate: 0.25 } },
  ]
